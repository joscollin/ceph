...
void FSMirror::init_instance_watcher(Context *on_finish) {
  ...
  m_instance_watcher = InstanceWatcher::create(m_ioctx, m_snap_listener, m_error_listener, m_work_queue);
...
void FSMirror::init_mirror_watcher() {
  ...
  m_mirror_watcher = MirrorWatcher::create(m_ioctx, this, m_error_listener, m_work_queue);
