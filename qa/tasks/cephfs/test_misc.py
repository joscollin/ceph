...
class TestMisc(CephFSTestCase):
    ...
    def test_dispatch_queue_throttle_message(self):
        ...
        """
        self.config_set('osd', 'ms_dispatch_throttle_bytes', 500)
        self.config_set('osd', 'ms_dispatch_throttle_log_interval', 5)
        self.config_set('osd', 'ms_dispatch_throttle_clog_interval', 5)
        self.config_set('mds', 'ms_dispatch_throttle_bytes', 10240)
        self.config_set('mds', 'ms_dispatch_throttle_log_interval', 5)
        self.config_set('mds', 'ms_dispatch_throttle_clog_interval', 5)
        # Create files & split across 10 directories, 1000 each.
        with self.assert_cluster_log("Throttler Limit has been hit. "
